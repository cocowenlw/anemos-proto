...
const (
	LLMService_Chat_FullMethodName = "/anemos.llm.v1.LLMService/Chat"
)
...
func (c *lLMServiceClient) Chat(ctx context.Context, in *Chatreq, opts ...grpc.CallOption) (*Chatrsp, error) {
...
func (UnimplementedLLMServiceServer) Chat(context.Context, *Chatreq) (*Chatrsp, error) {
...
func _LLMService_Chat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LLMServiceServer).Chat(ctx, req.(*Chatreq))
	}
...
var LLMService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "anemos.llm.v1.LLMService",
